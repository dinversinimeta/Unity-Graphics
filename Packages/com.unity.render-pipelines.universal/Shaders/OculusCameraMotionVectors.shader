Shader "Hidden/Universal Render Pipeline/CameraMotionVectors"
{
    SubShader
    {
        Pass
        {
            ...
            SamplerState sampler_PointClamp2;
            ...
            half4 frag(Varyings input, out float outDepth : SV_Depth) : SV_Target
            {
            ...
            #if _SUBSAMPLE_DEPTH
                float4 depth4 = GATHER_RED_TEXTURE2D_X(_CameraDepthTexture, sampler_PointClamp2, UnityStereoTransformScreenSpaceTex(uv));
                #if UNITY_REVERSED_Z
                ...
                #endif
            #else
                float depth = SAMPLE_TEXTURE2D_X(_CameraDepthTexture, sampler_PointClamp2, UnityStereoTransformScreenSpaceTex(uv)).x;
            #endif
